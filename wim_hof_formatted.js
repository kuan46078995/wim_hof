...
const sessionSet = Array.from({
    length: sessionNumber
}, (_, i) => i + 1);
...
setTimeout(() => {
    document.write('<h3>' + "Congratulations, you just finished you customized Wim Hof breathing session! Have a good day, night, and life!" + '</h3>');
}, finalDelay + 46000);
